...
| [CONTAINER_RATING_IMPLEMENTATION_PLAN.md](CONTAINER_RATING_IMPLEMENTATION_PLAN.md) | Container rating feature | `done` |
...
| [UNIFIED_MODEL_IMPLEMENTATION_PLAN.md](UNIFIED_MODEL_IMPLEMENTATION_PLAN.md) | Unified model implementation (frontend + backend V1 drop) | `done` |
| [UNIFIED_MODEL_V2_MISSING_FEATURES.md](UNIFIED_MODEL_V2_MISSING_FEATURES.md) | V2 missing features inventory (reporting/promotion/shelf life done; create-time account limits still open) | `done` |
