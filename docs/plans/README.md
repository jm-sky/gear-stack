...
| File | Summary | Status |
|------|---------|--------|
| [2026-07-15-inline-editing-ux-plan.md](2026-07-15-inline-editing-ux-plan.md) | Inline editing UX — LighterPack + Excel (Tab/Enter/Esc, auto-save) | `verification needed` |
