...
| 007 | [2026-07-05--007--container-list-not-refreshing-after-add.md](2026-07-05--007--container-list-not-refreshing-after-add.md) | Po dodaniu przedmiotu lista w kontenerze się nie odświeża | `done` |
...
| 044 | [2026-07-23--044--container-share-tokens-table-missing-prod.md](2026-07-23--044--container-share-tokens-table-missing-prod.md) | Backend (High): `container_share_tokens` nie istnieje na produkcji — endpointy share-token zwracają 500 | `in progress` |
