...
Per-item statuses: `todo` · `planned` · `in progress` · `done` · `verification needed`
...
## 6. UX: dodawanie istniejącego kontenera/przedmiotu z poziomu „Dodaj przedmiot" — `todo`
...
5. **Problemy kopiowania obrazów z katalogu** — patrz [2026-07-06-catalogue-images.md](2026-07-06-catalogue-images.md)
