...
export const COLOR_BORDER_CLASSES: Record<TContainerColor, string> = {
  ...
  coyote: 'border-amber-300',
  khaki: 'border-yellow-200',
  olive: 'border-lime-300',
  forestGreen: 'border-green-400',
  tan: 'border-amber-200',
  brown: 'border-amber-400',
  black: 'border-gray-600',
  navy: 'border-blue-700',
  jeans: 'border-blue-400',
...
export const COLOR_TEXT_CLASSES: Record<TContainerColor, string> = {
  ...
  coyote: 'text-amber-600',
  khaki: 'text-yellow-700',
  olive: 'text-lime-600',
  forestGreen: 'text-green-600',
  tan: 'text-amber-700',
