...
<template>
  <div v-if="hasLocalContainers" class="bg-card/50 backdrop-blur-sm rounded-lg border p-6 space-y-4">
    ...
    <!-- Login/Register CTA -->
    <div class="flex flex-col gap-6 justify-center items-center pt-4">
